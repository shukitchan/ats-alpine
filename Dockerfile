FROM --platform=linux/amd64 alpine:3.20.9 as builder-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.20.9 as builder-arm64
...
RUN curl -L https://downloads.apache.org/trafficserver/trafficserver-9.2.12.tar.bz2 | bzip2 -dc | tar xf - \
...
FROM --platform=linux/amd64 alpine:3.20.9 as worker-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.20.9 as worker-arm64
