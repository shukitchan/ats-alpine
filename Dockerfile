FROM --platform=linux/amd64 alpine:3.20.6 as builder-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.20.6 as builder-arm64
...
RUN curl -L https://downloads.apache.org/trafficserver/trafficserver-9.2.10.tar.bz2 | bzip2 -dc | tar xf - \
  && cd trafficserver-9.2.10/ \
...
FROM --platform=linux/amd64 alpine:3.20.6 as worker-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.20.6 as worker-arm64
