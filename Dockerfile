...
RUN apk add --no-cache --virtual .tools \
  bzip2 curl=7.79.1-r3 git automake libtool autoconf make \
...
RUN curl -L https://downloads.apache.org/trafficserver/trafficserver-9.1.4.tar.bz2 | bzip2 -dc | tar xf - \
