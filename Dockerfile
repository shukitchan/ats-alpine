FROM --platform=linux/amd64 alpine:3.23.5 as builder-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.23.5 as builder-arm64
...
RUN curl -L https://downloads.apache.org/trafficserver/trafficserver-9.2.14.tar.bz2 | bzip2 -dc | tar xf - \
  && cd trafficserver-9.2.14/ \
...
FROM --platform=linux/amd64 alpine:3.23.5 as worker-amd64

FROM --platform=linux/arm64 arm64v8/alpine:3.23.5 as worker-arm64
...
RUN apk add --repository=https://dl-cdn.alpinelinux.org/alpine/edge/main luajit=2.1_p20240815-r1
